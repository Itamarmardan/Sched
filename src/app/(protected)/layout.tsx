...
export default function ProtectedLayout({ children }: { children: ReactNode }) {
  return (
    <div
      id="app-shell"
      className="mx-auto flex h-[var(--app-height,100dvh)] min-w-0 max-w-2xl flex-col overflow-x-hidden bg-white sm:my-6 sm:h-[calc(100dvh-3rem)] sm:overflow-hidden sm:rounded-2xl sm:border sm:border-gray-200 sm:shadow-xl"
    >
